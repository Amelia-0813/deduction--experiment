    ...
    on_finish: function() {
        ...
        document.body.innerHTML = `
            <div style="text-align: center; padding: 60px; max-width: 700px; margin: 0 auto;">
                <h1 style="color: #28a745; margin-bottom: 30px;">✓ Data Ready for Download</h1>
                <p style="font-size: 20px; margin-bottom: 40px;">
                    Thank you for completing the study!
                </p>
                <p style="font-size: 18px; margin-bottom: 30px; color: #555;">
                    Please download your data file using the button below:
                </p>
                <a href="${url}" download="${filename}" 
                   style="display: inline-block; padding: 18px 40px; margin: 30px 0; 
...
const instructions = {
    ...
    pages: [
        ...
        `<div class="instructions-content">
            <h1>Rating Scale</h1>
            <p style="margin-bottom: 30px;">For each statement, you will rate it using this <strong>6-point scale</strong>:</p>
            <div class="scale-examples">
                ...
                <div style="margin: 12px 0; font-size: 18px;"><strong>3</strong> = Could be true</div>
        ...
        `<div class="instructions-content">
            ...
            <div style="font-size: 18px; line-height: 2; max-width: 700px; margin: 20px auto; text-align: left;">
                <ul>
                    <li>You will rate <strong>96 statements</strong></li>
                    ...
                    <li>You can take short breaks between statements</li>
                </ul>
            </div>
                ...
                <div style="margin-top: 30px;">
                    ...
                    <div class="rating-scale">
                        ...
                        <div class="scale-description">
                            <span class="scale-option"><strong>0</strong> = This statement doesn't make sense at all</span>
                            <span class="scale-option"><strong>1</strong> = Definitely false</span>
                            <span class="scale-option"><strong>2</strong> = Probably false</span>
                            <span class="scale-option"><strong>3</strong> = Could be true</span>
                            <span class="scale-option"><strong>4</strong> = Probably true</span>
                            <span class="scale-option"><strong>5</strong> = Definitely true</span>
                        </div>
                        <div style="text-align: center; margin-top: 35px;">
                            <strong style="font-size: 18px;">Select your rating:</strong>
                        </div>
                    </div>
                </div>
            `;
        ...
        const breakScreen = {
            ...
            stimulus: `
                <div style="text-align: center; padding: 50px;">
                    <h2 style="color: #28a745;">⏸ Time for a Short Break</h2>
                    ...
                    <p style="font-size: 20px;">That's <strong>${Math.round(((index + 1) / shuffledStatements.length) * 100)}%</strong> done!</p>
                    <div style="margin: 50px 0; padding: 30px; background-color: #f8f9fa; border-radius: 10px; max-width: 600px; margin-left: auto; margin-right: auto;">
                        <p style="font-size: 18px; color: #666;">
                            Feel free to rest your eyes and stretch for a moment.
                        </p>
                    </div>
    ...
    stimulus: function() {
        ...
        return `
            <div style="text-align: center; padding: 50px;">
                ...
                <div style="background-color: #f8f9fa; padding: 35px; border-radius: 12px; 
                            margin: 40px auto; max-width: 650px;">
                    <h3 style="margin-bottom: 25px;">Your Summary:</h3>
                    <p style="font-size: 18px; line-height: 2.0;">
                        <strong>List assigned:</strong> ${listType === 'odd' ? 'Odd pairs' : 'Even pairs'}<br>
                        <strong>Statements rated:</strong> ${shuffledStatements.length}<br>
                        <strong>Average rating:</strong> ${avgRating}<br>
                        <strong>Average response time:</strong> ${avgRT} seconds
                    </p>
                </div>
                ...
                <p style="font-size: 17px; color: #666; margin-top: 30px;">
                    Press any key to continue and download your data.
                </p>
            </div>
        `;
    },
